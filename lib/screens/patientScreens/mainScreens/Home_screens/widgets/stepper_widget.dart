...
class StepperWidget extends StatelessWidget {
  const StepperWidget({super.key, required this.careerpathList});
...
class SubscribedStepperWidget extends StatelessWidget {
  const SubscribedStepperWidget({super.key, required this.careerpathList});

  final List<subscribed_doctor.Careerpath> careerpathList;
