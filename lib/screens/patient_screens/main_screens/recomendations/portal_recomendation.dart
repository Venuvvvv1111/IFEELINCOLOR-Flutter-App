...
import 'package:ifeelin_color/controllers/patient_controllers/recomedation_controllers/portal_recomendation_controller.dart';
...
class PortalRecomendationScreen extends StatefulWidget {
  const PortalRecomendationScreen({super.key});

  @override
  State<PortalRecomendationScreen> createState() =>
      _PortalRecomendationScreenState();
}

class _PortalRecomendationScreenState extends State<PortalRecomendationScreen> {
  final PortalRecomendationController controller =
      Get.put(PortalRecomendationController());
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return controller.isLoading.value
          ...
          : (controller.totalportalRecomendations.value.value ?? 0) == 0
              ? const Center(child: Text('No Portal Recomendations'))
              : ListView.builder(
                  shrinkWrap: true,
                  itemCount:
                      controller.totalportalRecomendations.value.value ?? 0,
                  padding:
                      const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                  itemBuilder: (context, index) {
                    var allRecomendations =
                        controller.portalRecomendationModel?.body?[index];
                    if (kDebugMode) {
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'category- ${allRecomendations?.category}',
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .bodySmall,
                                                  ),
