...
import 'package:ifeelin_color/controllers/patient_controllers/subscription_controllers/my_subscription_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        else if (controller.mySubscriptionsModel?.body?.length == 0 ||
            controller.mySubscriptionsModel?.body?.length == null) {
          return const Center(
            child: Text('No Subscriptions Found'),
          );
        } else {
          return ListView.builder(
            itemCount: controller.mySubscriptionsModel?.body?.length,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Type: ${allSubscriptions?.plan?.planType ?? 'NA'}',
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                            Container(
                              padding: const EdgeInsets.symmetric(
