...
import 'package:ifeelin_color/screens/doctor_screens/doctor_account/widgets/doctor_profile_stepper_widget.dart';
...
class DoctorProfileDetailScreen extends StatefulWidget {
  ...
  @override
  State<DoctorProfileDetailScreen> createState() =>
      _DoctorProfileDetailScreenState();
}

class _DoctorProfileDetailScreenState extends State<DoctorProfileDetailScreen> {
  final getProfileController = Get.put(GetDoctorProfileController());
  final Completer<GoogleMapController> _controller =
      Completer<GoogleMapController>();
  @override
  void dispose() {
    super.dispose();
    Get.delete<GetDoctorProfileController>();
  }
        ...
        actions: [
          InkWell(
            onTap: () {
              Navigator.pushNamed(
                context,
                AppRoutes.doctorProfileEditScreen,
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "${getProfileController.getProfileModel?.body?.name}",
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: AutoSizeText(
                                                            "${getProfileController.getProfileModel?.body?.mobileNum}",
                                                            minFontSize: 8,
                                                            style: Theme.of(
                                                                    context)
                                                                .textTheme
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: AutoSizeText(
                                                            "${getProfileController.getProfileModel?.body?.email}",
                                                            minFontSize: 8,
                                                            style: Theme.of(
                                                                    context)
                                                                .textTheme
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: AutoSizeText(
                                                            'DOB : ${MediaQueryUtil.formatDoctorDateWithSuffix(DateTime.parse(getProfileController.getProfileModel?.body?.dob ?? "1985-07-15T00:00:00.000Z"))}',
                                                            minFontSize: 8,
                                                            style: Theme.of(
                                                                    context)
                                                                .textTheme
                          ...
                          child: SizedBox(
                            ...
                            child: GoogleMap(
                              ...
                              initialCameraPosition: CameraPosition(
                                target: LatLng(
                                    getProfileController.getProfileModel!.body!
                                        .address!.latitude!,
                                    getProfileController.getProfileModel!.body!
                                        .address!.longitude!),
                                zoom: 16.0,
                      ...
                      SizedBox(
                        ...
                        child: DoctorStepperWidget(
                          careerpathList: getProfileController
                                  .getProfileModel?.body?.careerpath
                                  ?.cast<Careerpath>() ??
                              [],
                        ),
                      ),
