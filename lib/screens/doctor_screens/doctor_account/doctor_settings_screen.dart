...
class DoctorSettingsScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DoctorSettingsScreen();
}

class _DoctorSettingsScreen extends State<DoctorSettingsScreen> {
      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF0547B6), Color(0xFF0547B6)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                SettingItems(
                  ...
                  title: 'Subscribed Patients',
                  ontap: () {
                    Navigator.pushNamed(
                        context, AppRoutes.subscriptionPatientsScreen);
                  },
                ),
                SettingItems(
                  image: AppIcons.subscribeMainIcon,
                  ...
                  ontap: () {
                    Navigator.pushNamed(
                        context, AppRoutes.doctorAppPortalSubscriptions);
                  },
                ),
                SettingItems(
